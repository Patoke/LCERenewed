...
You can download the IDA DB we use [HERE]() it will be updated as we progress through each title update currently we only allow changes in between TU 20-30.
