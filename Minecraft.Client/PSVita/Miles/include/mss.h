...
/*
    ...
    is straightforward. For compressed formats (like mp3), looping in sample space is
    non trivial and must be handled on a format-by-format basis. Some ASI formats
    may not support this functionality and will return failure.
